...
echo '<div>';
echo '<div style="font-size:22px;font-weight:800">Dashboard Administrativo</div>';
echo '<div style="margin-top:6px;color:rgba(234,240,255,.72);font-size:14px;line-height:1.6">Indicadores operacionais e atalhos do Admin.</div>';
echo '</div>';
