...
try {
    ...
    $api->updateGroupParticipants($groupJid, 'demote', [$memberId]);
    
    flash_set('success', 'Privilégios de administrador removidos!');
} catch (Exception $e) {
    flash_set('error', 'Erro ao remover admin: ' . $e->getMessage());
}
