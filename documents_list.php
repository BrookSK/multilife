...
echo '<div>';
echo '<div style="font-size:22px;font-weight:800">Gestão Documental</div>';
echo '<div style="margin-top:6px;color:rgba(234,240,255,.72);font-size:14px;line-height:1.6">Documentos por entidade + versões + validade.</div>';
echo '</div>';
...
echo '<select name="entity_type" style="border-radius:14px;border:1px solid rgba(255,255,255,.18);background:rgba(10,14,28,.55);color:var(--text);padding:10px 12px;outline:none;font-size:14px">';
...
echo '<input name="entity_id" value="' . h($entityId) . '" placeholder="ID entidade" style="width:160px;border-radius:14px;border:1px solid rgba(255,255,255,.18);background:rgba(10,14,28,.55);color:var(--text);padding:10px 12px;outline:none;font-size:14px">';

echo '<input name="category" value="' . h($category) . '" placeholder="Categoria (ex: Faturamento)" style="flex:1;min-width:220px;border-radius:14px;border:1px solid rgba(255,255,255,.18);background:rgba(10,14,28,.55);color:var(--text);padding:10px 12px;outline:none;font-size:14px">';
...
foreach ($rows as $r) {
    ...
    echo '<td style="padding:12px">' . h($ent) . '</td>';
    echo '<td style="padding:12px">' . h((string)$r['category']) . '</td>';
    echo '<td style="padding:12px">' . h((string)($r['title'] ?? '')) . '</td>';
    echo '<td style="padding:12px">' . h($ver) . '</td>';
    ...
    echo '<button class="btn" type="submit">Arquivar</button>';
    echo '</form>';
    echo '</td>';
    echo '</tr>';
}
