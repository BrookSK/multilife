...
echo '  fetch("' . $baseUrl . '/instance/connect/' . urlencode($instanceName) . '",{';
echo '    headers:{"apikey":"' . $apiKey . '"}';
echo '  })';
echo '  .then(r=>r.json())';
echo '  .then(data=>{';
...
echo '  fetch("' . $baseUrl . '/instance/connectionState/' . urlencode($instanceName) . '",{';
echo '    headers:{"apikey":"' . $apiKey . '"}';
echo '  })';
echo '  .then(r=>r.json())';
echo '  .then(data=>{';
