...
echo '    if(targetPanel) targetPanel.classList.add("isActive");';
echo '    console.log("Navegação concluída para:", targetId);';
echo '  });';
echo '});';
