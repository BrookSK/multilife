...
echo '<div>';
echo '<div style="font-size:22px;font-weight:800">Revisão #' . (int)$d['id'] . '</div>';
...
echo '<input type="hidden" name="id" value="' . (int)$d['id'] . '">';
echo '<textarea name="review_note" rows="2" placeholder="Motivo da reprovação (opcional)" style="flex:1;min-width:260px;border-radius:14px;border:1px solid rgba(255,255,255,.18);background:rgba(10,14,28,.55);color:var(--text);padding:10px 12px;outline:none;font-size:14px"></textarea>';
