...
echo '<div>';
echo '<div style="font-size:22px;font-weight:800">Usuários</div>';
echo '<div style="margin-top:6px;color:rgba(234,240,255,.72);font-size:14px;line-height:1.5">Gerencie usuários e seus acessos.</div>';
echo '</div>';
...
echo '<input name="q" value="' . h($q) . '" placeholder="Buscar por nome ou e-mail" style="flex:1;min-width:220px;border-radius:14px;border:1px solid rgba(255,255,255,.18);background:rgba(10,14,28,.55);color:var(--text);padding:10px 12px;outline:none;font-size:14px">';
