...
echo '<div style="margin-top:6px;color:hsl(var(--muted-foreground));font-size:14px;line-height:1.6">Gerencie propostas enviadas às operadoras / clientes e acompanhe respostas</div>';
echo '</div>';
...
echo '<input type="text" name="q" value="' . h($q) . '" placeholder="Paciente, profissional, operadora/cliente..." class="input">';
echo '</div>';
echo '<div style="flex:1;min-width:200px">';
...
echo '<li>Ao selecionar um profissional no chat, o sistema envia automaticamente um e-mail de proposta para a operadora / cliente</li>';
