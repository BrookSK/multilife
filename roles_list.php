...
echo '<div>';
echo '<div style="font-size:22px;font-weight:800">Perfis (Roles)</div>';
echo '<div style="margin-top:6px;color:rgba(234,240,255,.72);font-size:14px;line-height:1.5">Gerencie perfis de acesso.</div>';
echo '</div>';
