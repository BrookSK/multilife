...
echo '<div class="col6"><label>Naturalidade - Cidade<input name="birth_city" maxlength="120" placeholder="Cidade de nascimento"></label></div>';
echo '<div class="col6"><label>Naturalidade - Estado<input name="birth_state" maxlength="2" placeholder="UF" style="text-transform:uppercase"></label></div>';
...
echo '<div class="col6"><label>Cidade<input name="address_city" maxlength="120" placeholder="Cidade"></label></div>';
echo '<div class="col6"><label>Estado<input name="address_state" maxlength="2" placeholder="UF" style="text-transform:uppercase"></label></div>';
