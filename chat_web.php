...
echo '  const location = document.querySelector("[name=location]").value;';
echo '  console.log("Specialty:", specialty);';
echo '  console.log("State:", state);';
echo '  console.log("Location:", location);';
echo '  if(!specialty || !state || !location) {';
echo '    e.preventDefault();';
echo '    alert("❌ Erro: Preencha Especialidade e UF. O campo Location deve ser preenchido automaticamente.");';
echo '    console.error("Campos vazios:", {specialty, state, location});';
echo '    return false;';
echo '  }';
