...
echo '<div style="margin-top:6px;color:hsl(var(--muted-foreground));font-size:14px;line-height:1.6">Cadastrar nova especialidade. Configure os tipos de serviço e valores depois.</div>';
echo '</div>';
