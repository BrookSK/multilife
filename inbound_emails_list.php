...
foreach ($rows as $r) {
    ...
    echo '<a class="btn" href="/cron/openai_extract_email_to_demand.php?token=49$cpFu92&id=' . (int)$r['id'] . '&retry_errors=1&force=1" target="_blank" style="background:#10b981;color:white" title="Reprocessar este e-mail (força reprocessamento)">🔄 Reprocessar</a>';
    echo '</td>';
    echo '</tr>';
}
if (count($rows) === 0) {
